...
FILES_${PN} += "${@bb.utils.contains('MACHINE_FEATURES', 'qti-vm', "","${systemd_unitdir}/system/qcedev.service", d)}"
FILES_${PN} += "${@bb.utils.contains('MACHINE_FEATURES', 'qti-vm',"", "${systemd_unitdir}/system/multi-user.target.wants/qcedev.service", d)}"
FILES_${PN} += "${@bb.utils.contains('MACHINE_FEATURES', 'qti-vm',"", "${systemd_unitdir}/system/qrng.service", d)}"
FILES_${PN} += "${@bb.utils.contains('MACHINE_FEATURES', 'qti-vm', "", "${systemd_unitdir}/system/multi-user.target.wants/qrng.service", d)}"
