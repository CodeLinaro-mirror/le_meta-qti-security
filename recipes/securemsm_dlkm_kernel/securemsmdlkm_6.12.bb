...
DEPENDS += "linux-soc-headers kernel-module-soc-repo "
...
EXTRA_OEMAKE += "EXTRA_CFLAGS+=-I${STAGING_INCDIR}/media"
EXTRA_OEMAKE += "SOCINCLUDE=-I${KERNEL_PLATFORM_PATH}/${KERNEL_SRC_TYPE}/include"
...
do_install() {
    ...
    install -m 0644 ${S}/smmu-proxy/include/uapi/linux/*.h ${D}${includedir}/linux/
...
FILES:${PN}-dev += "${includedir}/linux/*.h"

RPROVIDES:${PN} += "kernel-module-msm-rng-${KERNEL_VERSION}"
RPROVIDES:${PN} += "kernel-module-qce50-${KERNEL_VERSION}"
RPROVIDES:${PN} += "kernel-module-qcedev-mod-${KERNEL_VERSION}"
