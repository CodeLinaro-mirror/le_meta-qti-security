...
SRC_URI_append_qrbx210-rbx = " ${@bb.utils.contains('GCCVERSION', '14.2%', 'file://0001-solve-aarch64-oe-linux-gcc-build-error.patch', '', d)}"
SRC_URI_append_qrbx210-rbx = " ${@bb.utils.contains('GCCVERSION', '14.2%', 'file://fscrypt', '', d)}"
...
do_patch() {
	...
	if ${@bb.utils.contains('GCCVERSION', '14.2%', 'true', 'false', d)}; then
